...
def importarModelo(modeloEscolhido):
    url = 'streamlit/predicao_com_historico_das_empresas/base/dataset_com_coluna_empresa.xlsx'
    ...
    atributosSelecionados = ['EMPRESA', 'RECEITA_VENDAS_BENS_OU_SERVICOS', 'CUSTO_DOS_BENS_OU_SERVICOS_VENDIDOS', 'DESPESAS_RECEITAS_OPERACIONAIS', 
...
st.header('Modelo de Predição de Empresas Sonegadoras de Impostos Estaduais - Com Histórico das Empresas')
