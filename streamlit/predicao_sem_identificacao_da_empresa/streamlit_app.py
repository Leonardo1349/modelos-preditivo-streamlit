...
def importarModelo(modeloEscolhido):
    ...
    #url = 'C:/Users/Leonardo/Desktop/Disponibilizar Modelos/streamlit/predicao_sem_identificacao_da_empresa/base/dataset_sem_coluna_empresa.xlsx'
...
'OBS: Modelo de Predição treinado através de uma Base de Dados sem a Identificação das Empresas'
